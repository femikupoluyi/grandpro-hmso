...
export const Input: FC<InputProps> = forwardRef<HTMLInputElement, InputProps>(
  ({ label, error, helpText, leftIcon, rightIcon, prefix, className = '', ...rest }, ref) => {
    return (
        ...
        <div className="relative">
          ...
          <input
            ...
            className={`
              ...
              py-2 text-base focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent
