...
const onboardingController = __importStar(require("./onboarding.controller"));
...
// Document upload
router.post('/applications/:applicationId/documents', upload.single('document'), onboardingController.uploadDocument);
